...
const cityPara=document.querySelector("[data-noCity")

let oldTab=userTab;
const API_KEY ="3948389909af8479226cfed4b3c25f37"
...
function renderWeatherInfo(weatherInfo){
    ...
    //cityName.appendChild(document.createTextNode(data?.name))
...
async function fetchSearchUserWeatherInfo(city){
    ...
    try {
        ...
        if(data.cod==404){
            ...
            cityPara.innerText=`${data.message}`
        }else{
            userInfoContainer.classList.add("active");
            renderWeatherInfo(data);
        }
